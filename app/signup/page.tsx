            ...
            <div id="main-wrapper" className="w-fit border border-stone-800 rounded-lg p-4 mx-auto">
                ...
                <div className="flex flex-col justify-start gap-2.5 text-white">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" required id="email" name="email" className="focus:ring-2 focus:ring-blue-500 focus:outline-none border border-stone-600 outline-none rounded-lg px-1.5 py-0.5" value={LogValues.username} onChange={handleInput} />
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="w-full">
                        <button className="w-full bg-blue-500 text-white py-1.5 rounded-lg cursor-pointer hover:bg-blue-600">Register Me</button>
                    </div>
                    <div className="text-center">
                        <p>Already a Member? <Link href="/login" prefetch={true} className="underline text-blue-600">Login</Link></p>
                    </div>
                </div>
            </div>
        </div>
